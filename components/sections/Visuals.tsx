        ...
        <div className="col-span-12 lg:col-span-7">
          <ul className="divide-y divide-black/10 border-y border-black/10">
            {VISUALS.map((item) => (
              ...
              >
                <h3 className="col-span-12 text-2xl font-medium tracking-tightest text-ink-950 sm:col-span-4">
                  {item.name}
                </h3>
                <p className="col-span-12 leading-relaxed text-ink-500 sm:col-span-8">
                  {item.copy}
                </p>
              </li>
            ))}
